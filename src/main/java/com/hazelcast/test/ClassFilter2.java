 ...
 */
public class ClassFilter2 implements Listed {
    ...
    public ClassFilter2 addClasses(String... names) {
        checkNotNull(names);
    ...
    public ClassFilter2 setClasses(Collection<String> names) {
        checkNotNull(names);
        classes.clear();
    ...
    public ClassFilter2 addPackages(String... names) {
        checkNotNull(names);
        for (String name : names) {
            packages.add(name);
        }
    ...
    public ClassFilter2 setPackages(Collection<String> names) {
        checkNotNull(names);
        packages.clear();
    ...
    public boolean equals(Object obj) {
        ...
        ClassFilter2 other = (ClassFilter2) obj;
