...
public class TestPolicyConfigurationFactory extends PolicyConfigurationFactory {
  ...
  private ConcurrentHashMap<String, TestPolicyConfiguration> policyConfigMap = new ConcurrentHashMap<String, TestPolicyConfiguration>();
  ...
  public PolicyConfiguration getPolicyConfiguration(String contextID, boolean remove) throws PolicyContextException {
    TestPolicyConfiguration pc = policyConfigMap.get(contextID);
    if (pc == null) {
      StateMachine sm = (StateMachine) configStateMachine.clone();
      pc = new TestPolicyConfiguration(contextID, policy, sm);
